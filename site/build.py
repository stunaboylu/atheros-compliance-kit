...
def json_ld(slug: str, locale: str, title: str, description: str, modified: str,
    ...
    software = {
        ...
        "inLanguage": ["en", "tr"],
        "description": (
            f"Python toolkit that produces EU AI Act evidence and ISO/IEC 42001 clause 8-9 records "
            f"from inside a customer's own codebase and CI: RAG corpus bias and quality scoring, "
...
<meta name="description" content="A Python toolkit that produces EU AI Act evidence and
 ISO/IEC 42001 clause 8-9 records from inside your own codebase and CI — RAG bias scoring,
...
that runs inside your own codebase and CI and produces the artefacts EU AI Act obligations and ISO/IEC 42001
clauses 8.3-8.5 and 9.1 ask for — automatically, hash-chained, and without your data leaving the process.</p>
...
> ISO/IEC 42001 clause 8-9 records from inside a customer's own codebase and CI. It runs as a library and a CLI, not
...
Under ISO/IEC 42001 it produces records for four clauses only: 8.3 operational controls
(`guard`), 8.4 data for AI systems (`rag`), 8.5 third-party relationships (`vendor`), and
9.1 monitoring and measurement (`core.audit`). It does NOT cover clauses 4-7 or 10, the
clause 9.2 internal audit programme, the clause 9.3 management review, the Statement of
Applicability, or the 38 Annex A controls. Those are management-system work that a tool
running inside a CI pipeline cannot perform.
